...
class MatchMaking(models.Model):
    class Status(models.IntegerChoices):
        Normal =0,"Normal"
        ReqSentByMale=1,"ReqSentByMale"
        ReqSentByFemale=2,"ReqSentByFemale"
        ReqAccepted=3,"ReqAccepted"
        ReqRejected=4,"ReqRejected"
        LockReqByMale=5,"LockReqByMale"
        LockReqByFemale=6,"LockReqByFemale"
        Locked=7,"Locked"
        CancelLockReqByMale=8,"CancelLockReqByMale"
        CancelLockReqByFemale=9,"CancelLockReqByFemale"
    ...
    statusReq=models.IntegerField(choices=Status.choices , default=Status.Normal)
    def __str__(self):
        return str(self.id)
